...
<div class="row">
    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
        ...
        <p>
            <strong>
                <?= Html::a($user->firstname . ' ' . $user->lastname, Yii::$app->homeUrl . $user->id,[ 'data-pjax'=>"0"]) ?>
            </strong>
        </p>
        ...
        foreach ($comments as $comment): ?>
            <li>
                    ...
                    <p>
                        <strong>
                            <?= Html::a($commentAuthor->firstname . ' ' . $commentAuthor->lastname, Yii::$app->homeUrl . $commentAuthor->id,[ 'data-pjax'=>0]) ?>
                        </strong>
                    </p>
